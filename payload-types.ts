...
export interface Work {
  ...
  year: string;
  /**
   * Upload a photo of the piece. Until one is set, the placeholder illustration below is used.
   */
  ...
  /**
   * Placeholder illustration SVG markup. Ignored once an image is uploaded.
   */
